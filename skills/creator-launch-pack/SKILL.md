...
description: "Turn a shipped mini-project into an educational launch post, reel hook, and changelog."
...
Turn a shipped mini-project into an educational launch post, reel hook, and changelog.
...
```text
Use the Creator Launch Pack skill.
