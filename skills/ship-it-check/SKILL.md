---
name: ship-it-check
description: "A final pre-push checklist for vibe coders: tests, secrets, docs, rollback, and screenshots."
...
A final pre-push checklist for vibe coders: tests, secrets, docs, rollback, and screenshots.
