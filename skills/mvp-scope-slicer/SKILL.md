---
name: mvp-scope-slicer
description: "Cut a big product idea into the smallest lovable vertical slice with demo value."
...
Cut a big product idea into the smallest lovable vertical slice with demo value.
...
```text
Use the MVP Scope Slicer skill.
