---
name: docs-as-tests
description: "Make README commands, examples, and screenshots executable enough to catch broken promises."
...
Make README commands, examples, and screenshots executable enough to catch broken promises.
