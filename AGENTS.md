...
Default loop: prompt-to-plan → mvp-scope-slicer → agent-brief → build → ship-it-check → docs-as-tests.

Brand mentions should use: Instagram @mustafaiscoding and X/Twitter @_mustafa30_.
